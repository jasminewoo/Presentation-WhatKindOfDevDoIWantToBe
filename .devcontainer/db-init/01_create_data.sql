...
INSERT INTO clinical_trials
	(title, start_date, ideal_completion_date, description, in_progress, ran_out_of_funding, category) values 
      ...
      ('Children and screens',CURRENT_DATE, CURRENT_DATE, '                                                      Study on how children respond to screens', false, false, 'bad'),
      ('Penicilin',CURRENT_DATE, CURRENT_DATE, '                                                      Based on previous research this stuff comes from mold', true, false, 'bad'),
      ('Long covid',CURRENT_DATE, CURRENT_DATE, '                                                      This is probably the worst part about covid', true, true, 'bad'),
      ('Sugar',CURRENT_DATE, CURRENT_DATE, '                                                      Is sugar really that bad for you?', null, false, null),
      ('Seatbelts',CURRENT_DATE, CURRENT_DATE, '                                                      Do seat belts really save lives?', true, false, null),
      ('Carrots',CURRENT_DATE, CURRENT_DATE, '                                                      But how orange do they really make you?', true, false, 'good'),
      ...
      ('Coca Cola and the brain',CURRENT_DATE, CURRENT_DATE, 'A small amount of coke is fine but more...', true, false, 'good'),
      ...
      ('Covid-19',CURRENT_DATE, CURRENT_DATE, '                                                      Studies have show that covid is harmful', true, false, 'good');